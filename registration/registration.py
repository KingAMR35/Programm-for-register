...
def add_user(users, username, password):
    ...
    if username in users:
        ...
        return f"Новый пользователь {username} успешно добавлен." # Задача: если пользователя в словаре нет, то добавить в словарь новую запись, ключ - имя пользователя, значение - пароль.
